...
class _$_HomeState implements _HomeState {
  const _$_HomeState({final List<TripModel> trips = const []}) : _trips = trips;
...
abstract class _HomeState implements HomeState {
  const factory _HomeState({final List<TripModel> trips}) = _$_HomeState;
